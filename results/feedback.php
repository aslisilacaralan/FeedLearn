...
<?php if (!$result): ?>
  <section class="section">
    <div class="card">
      <p class="error"><?php echo htmlspecialchars($evalError ?: 'No result found. Please submit an activity first.'); ?>
      </p>
...
<?php else: ?>
  ...
  <section class="section">
    <div class="card">
      ...
      <p><strong>Score:</strong> <span class="badge"><?php echo (int) $result['score_percent']; ?>%</span></p>
